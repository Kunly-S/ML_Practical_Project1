...
model_rest = load("Artifact\model_rest.joblib")
model_young = load("Artifact\model_rest.joblib")

scaler_rest = load("Artifact\scaler_rest.joblib")
scaler_young = load("Artifact\scaler_rest.joblib")
